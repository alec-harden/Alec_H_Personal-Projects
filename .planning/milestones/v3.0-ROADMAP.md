...
Plans:
- [ ] 16-01-PLAN.md — Schema + token infrastructure (emailVerificationTokens, emailVerified column, token functions)
- [ ] 16-02-PLAN.md — Verification routes + signup integration + admin badge
...
| 16 | Email Verification | Planned | 2 |
