...
Plans:
- [ ] 14-01-PLAN.md — Schema (disabled field) + login blocking
- [ ] 14-02-PLAN.md — User list page + create user
- [ ] 14-03-PLAN.md — User detail page + password reset + toggle disabled
...
| 14 | User Management (Admin) | Planned | 3 |
