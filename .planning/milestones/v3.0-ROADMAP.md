...
Plans:
- [ ] 18-01-PLAN.md — Schema + route scaffold (cutLists tables, /cutlist route, mode selector)
- [ ] 18-02-PLAN.md — Input forms (CutInputForm, StockInputForm, KerfConfig components)
- [ ] 18-03-PLAN.md — Optimization engine + results (placeholder algorithms, results display)
- [ ] 18-04-PLAN.md — Actions + persistence (clear all, save to project, enable dashboard card)
...
| 18 | Cut Optimizer Foundation | Planned | 4 |
