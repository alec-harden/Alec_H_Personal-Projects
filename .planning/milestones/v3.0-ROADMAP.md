...
Plans:
- [ ] 13-01-PLAN.md — Schema + type system + guards (role column, app.d.ts, requireAdmin)
- [ ] 13-02-PLAN.md — Retrofit admin routes + first admin logic
...
|-------|------|--------|-------|
| 13 | RBAC Foundation | Planned | 2 |
| 14 | User Management (Admin) | Pending | - |
| 15 | Email Infrastructure & Password Reset | Pending | - |
| 16 | Email Verification | Pending | - |
| 17 | BOM Refinements | Pending | - |
