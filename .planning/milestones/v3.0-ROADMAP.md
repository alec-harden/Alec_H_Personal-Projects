...
Plans:
- [ ] 19-01-PLAN.md — FFD algorithm enhancement (sort cuts descending, sort stock descending, linear feet summary)
- [ ] 19-02-PLAN.md — Linear cut diagram visualization (SVG component, diagram integration, kerf gaps)
