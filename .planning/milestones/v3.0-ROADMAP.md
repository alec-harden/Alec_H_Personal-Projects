...
Plans:
- [ ] 17-01-PLAN.md — Schema + eye icon toggle (dimension columns, BOMItem type, eye icon visibility)
- [ ] 17-02-PLAN.md — Dimension UI + board feet (lumber inputs, board feet calc, category total)
- [ ] 17-03-PLAN.md — CSV integration (export/import dimension columns)
